...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "sistema_medico_at_localhost";
		$data["connName"] = "sistema_medico at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;sistema_medico;;1"; //currently unused

		$this->_connectionsIdByName["sistema_medico at localhost"] = "sistema_medico_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "sistema_medico";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=sistema_medico;OPTION=3";
		// encription set
		...
		$connectionsData["sistema_medico_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["citas"] = "sistema_medico_at_localhost";
