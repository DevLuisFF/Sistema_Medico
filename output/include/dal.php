...
class tDAL
{
	...
	var $tblsistema_medico_at_localhost__usuarios;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "usuarios", "varname" => "sistema_medico_at_localhost__usuarios", "altvarname" => "usuarios", "connId" => "sistema_medico_at_localhost", "schema" => "", "connName" => "sistema_medico at localhost");
	}
