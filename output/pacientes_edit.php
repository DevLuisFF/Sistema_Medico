...
require_once("include/pacientes_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "pacientes_edit";
...
$page_layouts["pacientes_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "pacientes_list";
...
$page_layouts["pacientes_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "citas_list";
$layout->blocks["center"] = array();
$layout->containers["gridcontrols"] = array();
$layout->container_properties["gridcontrols"] = array(  );
$layout->containers["gridcontrols"][] = array("name"=>"wrapper",
...
$layout->blocks["topmiddle"][] = "masterinfo";
$page_layouts["citas_list"] = $layout;
...
$keys = array();
$keys["id_paciente"] = postvalue("editid1");
