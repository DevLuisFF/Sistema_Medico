...
$pageMask[$table] = $mask;
$tables[$table] = array("citas", " " . "Citas");
...
$pageMask[$table] = $mask;
$tables[$table] = array("especialidades", " " . "Especialidades");
$table = "medicos";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("medicos", " " . "Medicos");
$table = "pacientes";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("pacientes", " " . "Pacientes");
$table = "usuarios";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
