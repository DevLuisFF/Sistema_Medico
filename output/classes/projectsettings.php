...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "citas" ] = array( "url" => "citas", "type" => 0 );
	$projectEntitiesReverse[ "citas" ] = "citas";
	$projectEntities[ "especialidades" ] = array( "url" => "especialidades", "type" => 0 );
	$projectEntitiesReverse[ "especialidades" ] = "especialidades";
	$projectEntities[ "medicos" ] = array( "url" => "medicos", "type" => 0 );
	$projectEntitiesReverse[ "medicos" ] = "medicos";
