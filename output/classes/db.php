...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "sistema_medico_at_localhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "usuarios", "varname" => "sistema_medico_at_localhost__usuarios", "altvarname" => "usuarios", "connId" => "sistema_medico_at_localhost", "schema" => "", "connName" => "sistema_medico at localhost");
		}
	}
