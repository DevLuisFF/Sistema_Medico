...
$layout->containers["body"][] = array("name"=>"wrapper",
	"block"=>"", "substyle"=>1 , "container"=>"fb" );
$layout->containers["fb"] = array();
$layout->container_properties["fb"] = array(  );
$layout->containers["fb"][] = array("name"=>"facebookbutton",
	"block"=>"facebookbutton", "substyle"=>1  );
