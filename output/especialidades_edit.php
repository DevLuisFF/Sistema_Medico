...
require_once("include/especialidades_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "especialidades_edit";
...
$layout->containers["steps"][] = array("name"=>"multistep_nav_edit",
	"block"=>"", "substyle"=>1  );
...
$page_layouts["especialidades_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "especialidades_list";
...
$page_layouts["especialidades_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "medicos_list";
$layout->blocks["center"] = array();
$layout->containers["gridcontrols"] = array();
$layout->container_properties["gridcontrols"] = array(  );
$layout->containers["gridcontrols"][] = array("name"=>"wrapper",
...
$layout->blocks["topmiddle"][] = "masterinfo";
$page_layouts["medicos_list"] = $layout;
...
$keys = array();
$keys["id_especialidad"] = postvalue("editid1");
